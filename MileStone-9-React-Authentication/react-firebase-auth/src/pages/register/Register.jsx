    ...
    <div className="card mx-auto bg-base-100 w-full mt-10 max-w-sm shrink-0 rounded-lg shadow-md border border-transparent hover:p-3 transition-all duration-500 animate-fadeIn hover:border-green-500 hover:shadow-green-300 focus-within:border-green-600 focus-within:shadow-green-400 hover:text-green-600">
      <div className="card-body">
        ...
        <p>
          ...
          <Link
            to="/login"
            className="relative text-green-500 font-medium  transition-all duration-300 hover:text-white hover:font-semibold before:absolute before:-bottom-1 before:left-0 before:h-0.5 before:w-0 before:bg-green-600 before:transition-all before:duration-300 hover:before:w-full animate-fadeIn"
          >
            Login Now
          </Link>
        </p>
